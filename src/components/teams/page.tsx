              ...
              <CardContent>
                <p className="text-sm text-muted-foreground min-h-[40px]">{member.bio}</p>
                 <div className="flex justify-center gap-4 mt-4">
                  <ShimmerButton variant="ghost" size="icon" asChild><a href={member.social.linkedin}><Linkedin className="h-5 w-5"/></a></ShimmerButton>
                  <ShimmerButton variant="ghost" size="icon" asChild><a href={member.social.twitter}><Twitter className="h-5 w-5"/></a></ShimmerButton>
                </div>
              </CardContent>
            </Card>
          ))}
           ...
           {devTeam.map((member) => (
            <Card key={member.name} className="text-center overflow-hidden group transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground min-h-[40px]">{member.bio}</p>
                 <div className="flex justify-center gap-4 mt-4">
                  <ShimmerButton variant="ghost" size="icon" asChild><a href={member.social.github}><Github className="h-5 w-5"/></a></ShimmerButton>
                  <ShimmerButton variant="ghost" size="icon" asChild><a href={member.social.linkedin}><Linkedin className="h-5 w-5"/></a></ShimmerButton>
                </div>
              </CardContent>
            </Card>
